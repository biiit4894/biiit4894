...
|기간|경험사항|유형|비고|
|------|--------------|---|----------|
|`2024.01~2024.05`|🏃‍♀️ ESTsoft 백엔드 개발자 양성 과정 '오르미' 4기 수료|K-Digital Training|java, Spring Boot 학습 + FE 미니 프로젝트 1회 및 Spring 프로젝트 2회 진행|
|`2023.05~2023.08`|🔹 숙명여대 캠퍼스타운 스타트업 MVP 개발지원 서포터즈 '잇다' 활동|교내 비교과활동|웹 에이전시의 MVP 프로젝트 '소복'의 백엔드 개발 진행|
|`2022.10~2023.01`|⚫ 대학생 연합 IT벤처창업 동아리 SOPT 31기 서버파트 YB|동아리|Node.js 학습, 앱서비스 '킵고잇' 서버 개발 참여|
|`2022.01~2022.11`|📚 데이터 저널리즘 동아리 SURFER 개발팀장 | 동아리 | 데이터 저널리즘 기반 웹 기사 퍼블리싱 2회 진행|
|`2021.12~2022.12`|🔸 웹 개발 동아리 멋쟁이사자처럼 숙명여대 10기 운영진|동아리|동아리 운영 참여, Django 및 React.js 기초 세미나 6회 진행|
|`2021.03~2021.11`|🔸 웹 개발 동아리 멋쟁이사자처럼 숙명여대 9기 부원|동아리|Django 학습, 웹서비스 'Meet Wizard' 개발 참여|
<br>
